...
export default function Dashboard({
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-rows gap-5">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <h3 className="text-gray-800 text-2xl font-semibold dark:text-white">
                                Total Tasks
                            </h3>
                            <p className="text-xl mt-4">
                                <span className="ml-2">{totalAllTasks}</span>
                            </p>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
